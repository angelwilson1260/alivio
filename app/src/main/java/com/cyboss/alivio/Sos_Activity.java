...
public class Sos_Activity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String previousChildName) {
                ...
                myUserRef.child(fld.getUid()).child("name").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        nb= new Notification.Builder(Sos_Activity.this);
                        ...
                        Intent i =new Intent(Sos_Activity.this,MapsActivity.class);
                        Bundle b = new Bundle();
                        ...
                        PendingIntent pi =PendingIntent.getActivity(Sos_Activity.this,notification_request_code,i,PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.sign_out:
                ...
                mUsername=ANONYMOUS;
                startActivity(new Intent(Sos_Activity.this,MainActivity.class));
                finish();
                return  true;
            case R.id.view_location:
                startActivity(new Intent(Sos_Activity.this,LocationListActivity.class));
                return true;
//            case R.id.info:
//                startActivity(new Intent(Sos_Activity.this,AboutActivity.class));
//                return true;
            default:
    ...
    public void startSos(View view) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(Sos_Activity.this,
...
//        Log.d(TAG, "LastLocation: " + (ll == null ? "NO LastLocation" : lastLocation.toString()));
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Toast.makeText(Sos_Activity.this, "onConnectionFailed: \n" + connectionResult.toString(),
