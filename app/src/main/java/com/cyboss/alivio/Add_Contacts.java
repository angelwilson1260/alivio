...
public class Add_Contacts extends AppCompatActivity {
    ...
    private void addRealtimeUpdate() {
        DocumentReference contactListener = db.collection("Rescue").document("Contacts");
    ...
    private void DeleteData() {
        ...
        db.collection("PhoneBook").document("Contacts")
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(Add_Contacts.this, "Data deleted !",
    ...
    private void UpdateData() {
        ...
        contact.update(PHONE_KEY, "090-911-419")
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Add_Contacts.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void addNewContact(){
        ...
        db.collection("PhoneBook").document("Contacts").set(newContact)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Add_Contacts.this, "User Registered",
                                Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Add_Contacts.this, "ERROR" +e.toString(),
                                Toast.LENGTH_SHORT).show();
